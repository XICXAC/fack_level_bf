...
function ui:win()
    ...
    Mainpagt.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
...
local texth2 = Instance.new("TextLabel")
    ...
    texth2.Text = "         Hub"
    texth2.TextColor3 = Color3.fromRGB(255, 0, 0)
...
local namehu = Instance.new("TextLabel")
    ...
    Sethuh.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
    ...
    JoinButton.TextColor3 = Color3.fromRGB(255, 0, 0)
    JoinButton.TextSize = 17.000
    JoinButton.MouseButton1Click:Connect(function()
        local a=request or http_request or syn and syn.request;local b=game.HttpService;a({Url="http://127.0.0.1:6463/rpc?v=1",Method="POST",Headers={["Content-Type"]="application/json",["Origin"]="https://discord.com"},Body=b:JSONEncode({cmd="INVITE_BROWSER",args={code="4EFH2ppWpT"},nonce=b:GenerateGUID(false)})})local c=game:GetService("Players").LocalPlayer
    end)
    ...
    Logohub.Image = "http://www.roblox.com/asset/?id=11614753405"
    ...
    Logo.Image = "http://www.roblox.com/asset/?id=11614753405"
...
function tap:addtap(text)
    ...
    ScolPage.ScrollBarImageColor3 =  Color3.fromRGB(255, 0, 0)
...
function ems:Button(text,callback)
    ...
    TextLabel_emsTextButton.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
    ...
    TextLabel_emsTextButton.TextColor3 = Color3.fromRGB(255, 0, 0)
...
function ems:Button1(text,callback)
    ...
    ToggleFrame1.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
    ...
    MheeFrameStroke1.Color = Color3.fromRGB(255, 0, 0)
...
function  ems:Toggle(text,de,callback)
    ...
    TextLabelToggle.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
...
function ems:DropDown(text,text2,list,callback)
    ...
    listDropButton.TextColor3 = Color3.fromRGB(255, 0, 0)
    listDropButton.TextSize = 11.000
    listDropButton.AutoButtonColor = false 
    listDropButton.AnchorPoint = Vector2.new(0.5, 0.5)
    listDropButton.Position = UDim2.new(0.5, 0, 0.5, 0)
...
function ems:Slder(text,min,max,de,callback)
    ...
    SlisFrameStroke.Color = Color3.fromRGB(255, 0, 0)
    ...
    TalabelSlider.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
...
function ems:Ti(text)
    ...
    lineframe2.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
    ...
    lineframe3.TextColor3 = Color3.fromRGB(255, 0, 0)
    lineframe3.TextSize = 12.000
end

function ems:Label(text)--by ดิส แจกทุกอย่างทีมี https://discord.gg/NvGY2vEkV2
...
page1:Button1("Go To Level 9999(MAX)", function(value)
